...
public class InstructorController {
    ...
    public ResponseEntity < Instructor > getInstructorById(
    		@PathVariable(value = "id") Long instructorId) throws ResourceClosedException {
        Instructor user = instructorRepository.findById(instructorId)
            .orElseThrow(() -> new ResourceClosedException("Instructor not found :: " + instructorId));
    ...
    public ResponseEntity < Instructor > updateUser(
        ...
        @Valid @RequestBody Instructor userDetails) throws ResourceClosedException {
        Instructor user = instructorRepository.findById(instructorId)
            .orElseThrow(() -> new ResourceClosedException("Instructor not found :: " + instructorId));
